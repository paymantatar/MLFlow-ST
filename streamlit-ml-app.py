...
def main():
    # Front end
    st.title(
        "Welcome to Loan Application-Our Prediction is Based on RandomForestClassifier")
    ...
    Credit_History = st.selectbox(
        "Credit History", ("Outstanding Loan", "No Outstanding Loan"))
    Property_Area = st.selectbox(
        "Property Area", ("Rural", "Urban", "Semi Urban"))
